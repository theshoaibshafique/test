...
export default class MainLayout extends React.PureComponent {
  ...
  resourcesGathered(roles, userFacility) {
    ...
    this.setState({
      ...
      caseDiscoveryAccess: this.containsAny(roles, ["ADMIN"]) && (userFacility.toUpperCase() == "77C6F277-D2E7-4D37-AC68-BD8C9FB21B92" || userFacility.toUpperCase() == "0282953F-D4C9-47C0-904D-92849A394EEA" || userFacility.toUpperCase() == "DDE247F8-FE3F-45D8-B69A-1C5966FF52B0 ") || this.containsAny(roles, ["SSTADMIN"]),
