...
export const LEARNMORE_INFO = {
    "Efficiency": {
        ...
        content: {
            ...
            "View Only": "Has access to view Efficiency analytics. Users with this role can be given access to all <facility> analytics, or can be restricted to specific departments or rooms."
        }
    },
    "eM&M": {
        order: 1,
        content: {
            ...
            "View Only": "Has access to view <facility>’s Enhanced M&M reports. Users with this role can be given access to all <facility>’s Enhanced M&M reports, or can be restricted to specific departments or rooms."
        }
    },
    "Case Discovery": {
        order: 2,
        content: {
            ...
            "View Only": "Has access to view <facility> cases within Case Discovery. Users with this role can be given access to all <facility> cases, or can be restricted to specific departments or rooms."
        }
    ...
    "Surgical Safety Checklist": {
        ...
        content: {
            ...
            "View Only": "Has access to view <facility> Surgical Safety Checklist analytics. Users with this role can be given access to all <facility> analytics, or can be restricted to specific departments or rooms."
        }
    },
}