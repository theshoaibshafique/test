...
function DonutLabel({ viewBox, title, value, formattedValue }) {
  ...
  return (
    <>
      ...
      {formattedValue && (
        <text x={cx} y={cy + 40} fill="#004F6E" className="recharts-text recharts-label" textAnchor="middle" dominantBaseline="bottom" style={{ fontSize: 60, color: '#004F6E', fontWeight: 'bold' }}>
          {formattedValue}
        </text>
      )}
    </>
